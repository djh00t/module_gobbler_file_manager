...
# Include the source code of scrape.py in the documentation
from sphinx.ext import autodoc
from inspect import getsourcefile, getsourcelines

def include_source(app, what, name, obj, options, lines):
    if name == 'module' and obj.__name__ == 'scrape':
...
def setup(app):
    app.connect('autodoc-process-docstring', include_source)
