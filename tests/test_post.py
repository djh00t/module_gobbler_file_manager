...
def test_post_to_local_non_existent_directory():
    ...
    # Debug logging
    if debug_mode:
        logger.debug(f"Posting file to non-existent path: {path}")
...
def test_post_to_s3_invalid_bucket():
    ...
    # Debug logging
    if debug_mode:
        logger.debug(f"Posting file to S3 path: {s3_path}")
...
def test_post_to_s3_create_path():
    ...
    # Debug logging
    if debug_mode:
        logger.debug(f"Posting file to new S3 path: {new_s3_path}")
...
def test_post_to_s3_with_md5():
    ...
    # Debug logging
    if debug_mode:
        logger.debug(f"Posting file to S3 path with MD5: {s3_path}")
...
def test_post_to_local_with_md5():
    ...
    # Debug logging
    if debug_mode:
        logger.debug(f"Posting file to local path with MD5: {local_path}")
